 ...
 */
@Service
public class AopSqlReceiverServiceImp extends RabbitMQReceiverServiceImp implements AopSqlReceiverService {
    @Autowired
    ...
    public boolean onMessageEx1(Message message, Channel channel) throws Exception {
        try {
            ...
            System.out.println("corefirst成功消费 : " + mongojson);
    ...
    public boolean onMessageEx2(Message message, Channel channel) throws Exception {
        try {
            ...
            System.out.println("coresecond成功消费 : " + mongojson);
            System.out.println("message : " + s1);
            System.out.println("channel : " + s2);
            return true;
        } catch (Exception ex) {
